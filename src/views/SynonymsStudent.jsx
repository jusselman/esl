...
export default function SynonymsStudent() {
  ...
  const { tierTitle, tierEmoji, secondsPerQuestion, questions = [], currentQuestionIndex = -1, questionStartedAt, status = 'lobby' } = activityState

  // Waiting room — room/tier chosen, but the teacher hasn't begun yet.
      ...
      <div className={styles.root}>
        ...
        <div className={styles.waitingCard}>
          ...
          <p className={styles.waitingText}>
            {tierTitle ? `${tierEmoji} ${tierTitle} — waiting for your teacher to start…` : 'Waiting for your teacher to start…'}
          </p>
        </div>
      </div>
    )
