...
import { FILL_IN_TIERS, pickFillInQuestions } from '../data/fillItInSentences'
import styles from './FillItInSetup.module.css'
...
export default function FillItInSetup() {
  ...
  const handleLaunch = async () => {
    ...
    setLaunching(true)
    try {
      const questions = pickFillInQuestions(selectedTier, numQuestions)
      ...
      navigate(`/fill-it-in/host?room=${roomCode}`)
    } finally {
      setLaunching(false)
    }
  }
      ...
      <div className={styles.container}>
          ...
          <div className={styles.themeGrid}>
            {FILL_IN_TIERS.map((tier) => (
              ...
              >
                ...
                <div className={styles.themeCount}>{tier.questions.length} sentences available</div>
              </button>
            ))}
          </div>
        )}
        ...
        {step === 2 && (
          <div className={styles.configSection}>
            <div className={styles.configGroup}>
              <div className={styles.configLabel}>Number of sentences</div>
            ...
            <div className={styles.configGroup}>
              <div className={styles.configLabel}>Seconds per sentence</div>
              <div className={styles.optionRow}>
        ...
        {step === 3 && selectedTier && (
          <div className={styles.reviewCard}>
            ...
            <div className={styles.reviewSection}>
              <h3>Round Length</h3>
              <p>{numQuestions} sentences · {secondsPerQuestion} seconds each</p>
            </div>

            <div className={styles.reviewSection}>
              <h3>Format</h3>
              <p>Multiple choice — read the sentence, pick the word that fills the blank, live with the whole class.</p>
            </div>
          </div>
        )}
